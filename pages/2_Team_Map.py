...
# SECTION A
if not players.empty and not agg.empty:
    best = players.iloc[0]
    ...
    with cols[0]:
        ...
        if not agents.empty:
            ...
            fig_agent = go.Figure(go.Bar(
                ...
                textfont=dict(color='#1C1C24', family='Inter', weight='bold')
            ))
    ...
    with cols[1]:
        ...
        if not global_teams.empty:
            ...
            if not t_rank_row.empty:
                ...
                # Show top 10 plus current team if outside top 10
                ...
                # Adjust margin to fit team names
                fig_rank.update_layout(margin=dict(l=100, r=20, t=20, b=40))
